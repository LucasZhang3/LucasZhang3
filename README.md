...
**01 · [UnderwaterRobotics-NURC](https://github.com/LucasZhang3/UnderwaterRobotics-NURC)**

![ROV](https://img.shields.io/badge/ROV-Competition-0ea5e9?style=flat-square)
![ASU](https://img.shields.io/badge/ASU-Robotics%20Camp-8b1a1a?style=flat-square)
![C++](https://img.shields.io/badge/C++-00599C?style=flat-square&logo=cplusplus&logoColor=white)
![Teensy](https://img.shields.io/badge/Teensy-6366f1?style=flat-square)

<br />

Full ROV stack with Teensy firmware, tether protocol, and build documentation. Built at the ASU Underwater Robotics Camp and competed at the National Underwater Robotics Challenge.

<br /><br />

**02 · [BMECS-EPICS](https://github.com/LucasZhang3/BMECS-EPICS)**

![ASU EPICS](https://img.shields.io/badge/ASU-EPICS-8b5cf6?style=flat-square)
![C++](https://img.shields.io/badge/C++-00599C?style=flat-square&logo=cplusplus&logoColor=white)
...
Smart garden system for Phoenix community beds: shade canopy, drip irrigation, runoff capture, ESP32 sensor firmware, and Python CAD tooling. Developed for Tiger Mountain Foundation.

<br /><br />

**03 · [ManualMapper](https://github.com/LucasZhang3/ManualMapper)**

![Windows](https://img.shields.io/badge/Windows-x64-0078d4?style=flat-square&logo=windows&logoColor=white)
![C++](https://img.shields.io/badge/C++-00599C?style=flat-square&logo=cplusplus&logoColor=white)
![ImGui](https://img.shields.io/badge/ImGui-333333?style=flat-square)

<br />

Windows x64 manual DLL mapper with an ImGui GUI, CLI, loader shellcode, and a reference payload. Built for local debugging and security research.
...
A growing archive of C++ solutions for Codeforces problems.
...
![C++](https://img.shields.io/badge/C++-00599C?style=flat-square&logo=cplusplus&logoColor=white)
![ImGui](https://img.shields.io/badge/ImGui-333333?style=flat-square)
![DirectX](https://img.shields.io/badge/DirectX-0078D7?style=flat-square&logo=directx&logoColor=white)

<br />

Skin, knife, and glove changer with DXGI hooks, an ImGui menu, and JSON config persistence.
...
ESP overlay DLL with player visuals, skeletons, footsteps, and an in-game menu.
